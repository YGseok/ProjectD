...
##   - 침묵의 무녀(shieldbearer, 방어 다이스 최댓값 스택, 2026-09-24 리스킨 — 이름만
##     "방패병"→"침묵의 무녀", id/기믹/수치 불변): 공격 3 / 방어 4 — 폭발병과 대칭
##
...
const PROFILES := [
	...
	},
	{
		"id": "shieldbearer",
		"name": "침묵의 무녀",
		"desc": "음침하고 말이 없는 무녀 — 방어 다이스가 최댓값을 보여줄 때마다 수호 스택이 쌓임 (3스택에서 다음 방어가 20면체 주사위로 굳건해짐). 시작 다이스: 공격 D4x3 / 방어 D4x4 (스택을 더 자주 쌓음)",
		"concept": "음침하고 말이 없는 무녀 — 방어 다이스가 최댓값을 보여줄 때마다 수호 스택이 쌓임(기존 방패병 기믹과 완전히 동일, 이름만 교체).",
		"gimmick": "guard_stack",
		"attack_count": 3,
		"defense_count": 4,
		"event_die_sides": 6,
