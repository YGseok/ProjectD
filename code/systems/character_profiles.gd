...
##   - 주술사(shieldbearer, 방어 다이스 최댓값 스택, 2026-09-24 리스킨 — 이름만
##     "방패병"→"침묵의 무녀"→"주술사", id/기믹/수치 불변): 공격 3 / 방어 4 — 폭발병과 대칭
##
...
const PROFILES := [
	...
	},
	{
		"id": "shieldbearer",
		"name": "주술사",
		"desc": "음침한 주술사 — 고통을 받아낼 때마다(방어 다이스가 최댓값을 보일 때마다) 저주 술식이 쌓여, 3번째에서 술식이 완성돼 다음 방어가 20면체 주사위로 화답함. 시작 다이스: 공격 D4x3 / 방어 D4x4",
		"concept": "음침하고 말이 없는 주술사 — 방어 다이스가 최댓값을 보일 때마다 저주 술식이 쌓임(기존 방패병 기믹과 완전히 동일, 이름/컨셉만 '방어형' 대신 저주·술식으로 재서술).",
		"gimmick": "guard_stack",
		"attack_count": 3,
		"defense_count": 4,
		"event_die_sides": 6,
